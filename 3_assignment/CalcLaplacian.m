function [eigvecs1,eigvecs2, L1, L2]=CalcLaplacian(W)
...
D = spdiags(d,0,num_points,num_points);
D12 = full(D)^(-1/2);
L1 = (D-W);
L2 = eye(200) - D12*W*D12;
% Compute first 2 eigenvectors
[eigvecs1,eigvals] = try_compute_eigvecs(L1,2);
[eigvecs2,eigvals] = try_compute_eigvecs(L2,2);
